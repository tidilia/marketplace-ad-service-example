...
def get_increment_views(uow: UowDep) -> IncrementViewsPort:
    return IncrementViews(uow)
...
IncrementViewsDep = Annotated[IncrementViewsPort, Depends(get_increment_views)]
